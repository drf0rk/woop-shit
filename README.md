...
[Changelog](#changelog) • [Usage](#usage) • [Wiki](https://github.com/drf0rk/woop-shit/wiki)


Uncensored Deepfakes for images and videos without training and an easy-to-use GUI.


![Screen](https://github.com/drf0rk/woop-shit/assets/131583554/6ee6860d-efbe-4337-8c62-a67598863637)
...
Please refer to the [wiki](https://github.com/drf0rk/woop-shit/wiki).

#### macOS Installation
Simply run the following command. It will check and install all dependencies if necessary.

`/bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/PJF16/woop-shit/master/installer/macOSinstaller.sh)"`
...
- Dockerfile:
  ```shell
  docker build -t woop-shit . && docker run -t \
    -p 7860:7860 \
...
<a target="_blank" href="https://colab.research.google.com/github/drf0rk/woop-shit/blob/main/woop-shit.ipynb">
...
- Bugfix: Starting woop-shit without NVIDIA gpu but cuda option enabled
...
- New auto rotation of horizontal faces, fixing bad landmark positions (expanded on ![PR 364](https://github.com/drf0rk/woop-shit/pull/364))
