...
# This script checks and installs all dependencies which are needed to run woop-shit. After that, it clones the repo.
# Execute this easily with /bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/PJF16/woop-shit/master/installer/macOSinstaller.sh)
...
echo "Starting check and installation process of dependencies for woop-shit"
...
REPO_URL="https://github.com/drf0rk/woop-shit.git"
REPO_NAME="woop-shit"
